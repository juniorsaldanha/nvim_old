...
-- vim.cmd[[
-- nnoremap <S-j> <cmd>call smoothie#do("\<C-D>") <CR>
-- vnoremap <S-j> <cmd>call smoothie#do("\<C-D>") <CR>

-- nnoremap <S-k> <cmd>call smoothie#do("\<C-U>") <CR>
-- vnoremap <S-k> <cmd>call smoothie#do("\<C-U>") <CR>
-- ]]
...
vim.g.smoothie_update_interval = 15
